...
install:
	install -Dm644 xorg.nvidia.conf $(PRIMECONFDIR)/xorg.nvidia.conf
	install -Dm644 xorg.intel.conf $(PRIMECONFDIR)/xorg.intel.conf
	...
	install -Dm644 nvidia-prime.png $(DATADIR)/pixmaps/nvidia-prime.png
	install -Dm644 nvidia-prime-ui.desktop $(DATADIR)/applications/nvidia-prime-ui.desktop
	install -Dm644 nvidia-prime.service $(UNITDIR)/nvidia-prime.service
	install -Dm644 com.github.pkexec.nvidia-prime-ui.policy $(DATADIR)/polkit-1/actions/com.github.pkexec.nvidia-prime-ui.policy
uninstall:
